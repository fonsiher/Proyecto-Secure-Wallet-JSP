...
<LINK REL=StyleSheet HREF="estilos/estilo.css" TYPE="text/css"
	MEDIA=screen>
<title>Editar Tipos de Gastos</title>
</head>
<body>
	...
	<div class="main" align="center">
		...
		<%
			Tipos_gastos tg = new Tipos_gastos();
			String usuarios =tg.listarTipos();
			out.print(usuarios);
		%>

		<p align="center"><a href="menuPrincipal.jsp"><h4>Volver al Menú Principal</h4></a></p>
